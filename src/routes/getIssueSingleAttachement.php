...
$app->post('/api/Bitbucket/getIssueSingleAttachement', function ($request, $response, $args) {
    ...
    $query_str = "https://api.bitbucket.org/2.0/repositories/{$post_data['args']['username']}/{$post_data['args']['reposlug']}/issues/{$post_data['args']['issueId']}/attachments/{$post_data['args']['attachement']}";
        ...
        if ($resp->getStatusCode() == 200) {
            ...
            $uploadServiceResponse = $client->post($settings['uploadServiceUrl'], [
                'multipart' => [
                    ...
                    [
                        "name" => "file",
                        "filename" => $post_data['args']['attachement'],
